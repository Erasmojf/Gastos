...
extension Category {
    ...
    static let entertainment = Category(id: 3, name: "Etertainment", icon: .film)
    ...
    static let publictTransportation = Category(id: 101, name: "Public Transportation", icon: .bus, mainCategoryId: 1)
    ...
    static let software = Category(id: 801, name: "Sotfware", icon: .icons, mainCategoryId: 8)
